...
if(isset($_POST['submit'])){
	...
	if(1 == 1){
		...
		//if(mysqli_num_rows($result_clients_id) > 0){
			...
			You will be automtically redirected to List of Pupils Page in 3 seconds.</div>';
			
			echo '<script>setTimeout(function(){ window.location.replace("specific-pupils-lists.php");}, 3000);</script>';
