...
<h1>Editing Pupil With ID <?php echo $_GET['ID']; ?></h1>

<form method="post" action="edit-pupil-submit.php">
...
<div class="form_father">
	...
	<input type="text" id="bankID" name="bankID" value="<?php echo $row['bankID']; ?>" >
</div>
...
<div class="form_father">
	...
	<input type="text" id="applied_on" name="applied_on"  value="<?php echo ($is_admin = ($row['Applied On'] == '0000-00-00 00:00:00') ? '' : date('d-m-Y H:i:s', strtotime($row['Applied On']))); ?>" >
</div>
...
<div class="form_father">
	...
	<input type="text" id="theocert" name="theocert" pattern="[0-9]+" value="<?php echo $row['Theory Cert']; ?>" >
</div>
...
<div class="form_father">
	...
	<input type="text" id="temp_booking_date" name="temp_booking_date" value="<?php echo ($is_admin = ($row['Temp Booking Date'] == '0000-00-00 00:00:00') ? '' : date('d-m-Y H:i:s', strtotime($row['Temp Booking Date']))); ?>" >
</div>
...
<div class="form_father">
	...
	<input type="text" id="temp_booking_code" name="temp_booking_code" value="<?php echo $row['Temp Booking Code']; ?>" >
</div>
...
<body>
    <p>Click on the button to copy SPECIFIC LIST ID </p>

    <button onclick="myFunction()">Copy SPECIFIC LIST ID</button>
