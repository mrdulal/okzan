...
<?php
$total_pages_sql = 'SELECT COUNT(*) FROM clients WHERE `Balance` > 0 AND `credit_limit` < 10000000' ;
...
<h1>Payments Due - All, <?php echo $totalitems; ?> in total</h1>
...
$sql = 'SELECT * FROM clients WHERE `Balance` > 0 AND `credit_limit` < 10000000 ORDER BY ID ASC';
