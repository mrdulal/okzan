...
$sql_special = 'SELECT * FROM pupils WHERE `Special Code` != \'\' ORDER BY '.$sorting;
...
$sql_not_wood_green = 'SELECT * FROM pupils WHERE `Test Centre` NOT LIKE \'%Wood Green%\' AND `Booked For` >= "'.date('Y-m-d', time()).'" AND `Special Code` = \'\' ORDER BY '.$sorting;
...
$sql_wood_green = 'SELECT * FROM pupils WHERE `Test Centre` LIKE \'%Wood Green%\' AND `Booked For` >= "'.date('Y-m-d', time()).'" AND `Special Code` = \'\' ORDER BY '.$sorting;
...
$sql_elapsed = 'SELECT * FROM pupils WHERE `Booked For` < "'.date('Y-m-d', time()).'" AND `Booked For` > "0000-00-00 00:00:00" AND `Special Code` = \'\' ORDER BY '.$sorting_elesped.$sorting;
